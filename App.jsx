...
const App = () => {
  ...
  // Comprehensive countries database (195+ countries)
  const allCountries = {
    'north-america': [
  ...
  const selectAllInFilter = (filterKey, allValues) => {
  ...
  const handleSubscribe = (newsItem) => {
            ...
            <div className="grid grid-cols-12 gap-3">
              ...
              <div className={filters.useCustomDate ? "col-span-5" : "col-span-9"}>
                ...
                <input 
                  ...
                  onChange={(e) => setFilters(prev => ({ ...prev, customTopic: e.target.value }))}
                  ...
                  <div className="absolute top-full mt-2 w-full bg-slate-800 border border-white/20 rounded-lg shadow-2xl z-50 max-h-96 overflow-y-auto">
                    ...
                    {filteredCountries.length === 0 ? (
                      <div className="p-4 text-center text-gray-400 text-sm">
                        {filters.regions.length === 0 ? 'Select a region first' : 'No countries in selected regions'}
                      </div>
                    ) : (
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className="flex flex-col gap-2 ml-4">
                        <button 
                          onClick={(e) => { e.stopPropagation(); saveArticle(item.id); }}
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-white/10">
                      ...
                      <button 
                        onClick={(e) => { e.stopPropagation(); handleSubscribe(item); }}
